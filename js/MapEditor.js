...
function MapEditor(divID, loadXML,notAllowEdit,onlyMap) {
	 ...
	 */
	var scriptConfig = {
		background:"./img/mapeditor/spelplan.png",
		player:"./img/mapeditor/player.png",
		obstacle:"./img/mapeditor/obstacle.png",
	...
	var playerListDir = [{
		...
		val:"90s",
		text:"Small Snake 90",
		url:"./img/mapeditor/player90.png",
		x:14,
		y:34,
		angle:90,
		offsetX:7,
		...
		url:"./img/mapeditor/player180.png",
		x:34,
		y:14,
		angle:180,
		offsetX:7,
		...
		url:"./img/mapeditor/player270.png",
		x:14,
		y:34,
		angle:270,
		offsetX:7,
 ...
 */
	...
	var self = {
		...
		makeUI:function(mainDiv, onlyEditor) {
			if(!onlyEditor) {
				mainDiv.css("backgroundColor", "#white");mainDiv.css("position", "relative");
