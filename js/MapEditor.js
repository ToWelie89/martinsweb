...
function MapEditor(divID, loadXML, notAllowEdit, onlyMap) {
	 ...
	 */
	var scriptConfig = {
			background: "../img/build/spelplan.png",
			player: "../img/build/player.png",
			obstacle: "../img/build/obstacle.png",
